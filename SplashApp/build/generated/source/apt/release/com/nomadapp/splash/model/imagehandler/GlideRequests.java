...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.nomadapp.splash.model.imagehandler.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.nomadapp.splash.model.imagehandler.GlideOptions().apply(toSet));
    }
  }
}
